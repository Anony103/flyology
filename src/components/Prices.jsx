...
const Prices = () => {
  ...
  return (
    ...
    <section className="py-8 md:px-8 lg:px-16 xl:px-20" data-aos="zoom-in">

        <section className='md:p-4 grid grid-cols-4 lg:grid-cols-4md:gap-4' data-aos="fade-up">
            ...
            <section key={item.id} className='flex flex-col mt-12 max-w-sm gap-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:opacity-90 hover:scale-105  hover:text-black' >
                ...
                <ul className='border-r-4 border-gray-100 md:p-4 flex flex-col items-center justify-center'>
                    ...
                    <li className='flex md:gap-2' key={index}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 md:w-6 md:h-6 text-emerald-800">
                    ...
                    <span className="fonts-Karla text-white text-xs md:text-base font-medium">{items}</span>
                    </li>
                    )}
                </ul>
